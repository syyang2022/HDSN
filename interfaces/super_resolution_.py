    ...
    def train(self):
        ...
        for epoch in range(cfg.epochs):
            for j, data in (enumerate(train_loader)):
                ...
                loss = image_crit(sr_img,images_hr).mean() * 100#ESRGAN
    ...
    def test(self):
        ...
        for test_dir in items:
            ...
            for i, data in (enumerate(test_loader)):
                ...
                save_image(images_sr,f'/mnt/sdb/xlf/FudanOCR-main2/scene-text-telescope/img_sr/{i}.png')
                # print('srshape',images_sr.shape)1
