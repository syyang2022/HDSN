...
from model import tbsrn, tsrn, edsr, srcnn, srresnet, crnn,rdn,vdsr,esrgan,bicubic,lapsrn,hdsn
...
class TextBase(object):
    ...
    def generator_init(self):
        ...
        elif self.args.arch == 'hdsn':
            model = hdsn.hdsn(scale_factor=self.scale_factor, width=cfg.width, height=cfg.height,
                              STN=self.args.STN, mask=self.mask, srb_nums=self.args.srb, hidden_units=self.args.hd_u)
            image_crit = text_focus_loss.TextFocusLoss(self.args)
