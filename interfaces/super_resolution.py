    ...
    def train(self):
        ...
        for epoch in range(cfg.epochs):
            for j, data in (enumerate(train_loader)):
                ...
                activation='none')
                _, ctrl_points_x = self.stn_head(images_lr)
                images_lr, _ = self.tps(images_lr, ctrl_points_x)
                #'''''
    ...
    def test(self):
        ...
        for test_dir in items:
            ...
            for i, data in (enumerate(test_loader)):
                ...
                #save_image(images_sr,f'/mnt/sdb/scene-text-telescope/img_sr/{i+1}.png')
